...
<table class="table table-striped">
        ...
        $precio_total += $venta[0]->precio*$venta[0]->cantidad; ?>
            <tr class='tabla_<?php echo $venta[0]->compra_id;?>_<?php echo $venta[0]->producto_id; ?>'>
                ...
                <?php if ($venta[0]->descuento != 0) {
                    ...
                    echo "<td class='descuento_".$venta[0]->compra_id."_".$venta[0]->producto_id."' data-value='".$descuento2."'>$ ".$descuento2." (".$venta[0]->descuento."%)</td>"; 
                } ?>
  ...
  <tr>
      ...
      <td></td>
      <td></td>
      <td id='precio_sin_descuento' data-value='<?php echo $precio_total; ?>'>$ <?php echo $precio_total; ?></td>
